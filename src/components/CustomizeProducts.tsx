  ...
  return (
    <div className="flex flex-col gap-6">
          {productOptions.map((option) => (
                  ...
                  <ul className="flex items-center gap-3">
                  {
                      option.choices?.map((choice) => {
                          ...
                          return option.name === "Color" ? (
                            <li
                              className="w-8 h-8 rounded-full ring-1 ring-gray-300 relative bg-pink-800"
                              style={{
                            ...
                            <li
                              ...
                              style={{
                                ...
                                cursor: disabled ? "not-allowed" : "pointer",
                                color:
                                  selected || disabled ? "white" : "#F35C7A",
              ...
              <Add productId={productId} variantId = {selectedVariant?._id || "00000000-0000-0000-000000000000"} stockNumber={selectedVariant?.stock?.quantity || 0}/>
    </div>
  );
};
